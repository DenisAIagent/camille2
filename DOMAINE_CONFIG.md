...
Ce guide explique comment connecter le domaine personnalisé à Vercel une fois le projet validé.
...
1. Se connecter à [Vercel Dashboard](https://vercel.com/dashboard)
...
6. Vercel va demander de vérifier la propriété du domaine

### 2. Configurer les DNS chez le Registrar

Vercel vous donnera les enregistrements DNS à ajouter. Voici les valeurs typiques :
...
Vercel gère automatiquement la redirection entre `www` et non-www une fois configuré.
...
4. Vérifier le certificat SSL (automatique avec Vercel)
...
**Solution:** Attendre 5-10 minutes, Vercel génère automatiquement le certificat
...
2. **Garder l'URL Vercel (`camille-alpha.vercel.app`) active** pendant 1 semaine en parallèle
...
- Support Vercel: Live chat disponible sur le dashboard
