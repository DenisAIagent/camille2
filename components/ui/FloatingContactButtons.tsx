        ...
        <>
            <div className="fixed right-6 bottom-6 z-50 flex flex-col gap-4">
                ...
                >
                    ...
                    {/* Tooltip */}
                    <span className="absolute right-full mr-3 px-3 py-2 bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 text-sm font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none shadow-lg">
                        WhatsApp
                    </span>
