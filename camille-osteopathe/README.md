...
[![Deployed](https://img.shields.io/badge/Deployed-Production-green?style=flat)](https://osteopatiaemlisboa.com)
...
- ✅ **Rate limiting** (via plateforme d'hébergement)
- ✅ **HTTPS** obligatoire
...
Les secrets doivent être dans les variables d'environnement de la plateforme d'hébergement.
...
1. **Connecter le repository**
   - Projet configuré et déployé sur la plateforme d'hébergement
...
3. **Domaine personnalisé**
   - Domaine `osteopatiaemlisboa.com` configuré
   - DNS configuré (voir [DOMAINE_CONFIG.md](./DOMAINE_CONFIG.md))

4. **Déploiement automatique**
   - Push sur `main` → Déploiement automatique (si configuré)
...
2. Vérifier les logs de la plateforme d'hébergement (section Logs du dashboard)
...
- Documentation de la plateforme d'hébergement
...
- Plateforme d'hébergement cloud pour le déploiement
