...
Pour faire fonctionner le backend du site (API Contact), vous devez configurer les variables d'environnement suivantes dans Vercel ou dans votre fichier `.env.local` (en développement).
...
3. Les logs dans Vercel (Functions → Logs)
